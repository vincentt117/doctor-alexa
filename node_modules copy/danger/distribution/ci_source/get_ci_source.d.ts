 ...
 */
export declare function getCISourceForExternal(env: Env, modulePath: string): CISource | undefined;
/**
 * Gets a CI Source.
 * @export
 * @param {Env} env The environment.
 ...
 * @returns {?CISource} a CI source if module loaded successfully, undefined otherwise
 */
export declare function getCISource(env: Env, modulePath: string): CISource | undefined;
